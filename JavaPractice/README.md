...
2. **Identify constraints** - array size, time limits, space limits
3. **Look for keywords** - sorted, pairs, frequency, nested, etc.
4. **Consider data structures** - what would help solve this efficiently?
5. **Think about time complexity** - can we do better than brute force?
...
## How to Use
1. Each file contains minimal working code
2. Comments include LeetCode problem references
3. **Pattern recognition** section helps identify similar problems
4. Practice by implementing similar problems
5. Extend solutions for edge cases
